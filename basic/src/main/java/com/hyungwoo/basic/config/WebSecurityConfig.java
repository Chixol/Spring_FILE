package com.hyungwoo.basic.config;
...
import com.hyungwoo.basic.filter.JwtAuthenticationFilter;
import com.hyungwoo.basic.provider.OAuth2SuccessHandler;
...
public class WebSecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity security) throws Exception {
        ...
        // - Rest API 서버는 사용자 정보 및 상태를 클라이언트가 유지하기 때문에 session을 생성하지 않음
...
// 인증 실패 처리를 위한 커스텀 예외 처리 (FailedAuthenticationEntryPoint 인터페이스 구현)
