...
import com.hyungwoo.basic.entity.StudentEntity;
import com.hyungwoo.basic.repository.StudentRepository;
...
public class StudentServiceImplement implements StudentService {
    ...
    // - boolean matches(평문 패스워드, 암호화된 패스워드) : 평문 패스워드와 암호화된 패스워드가 같은지 비교를 반환
    ...
    public ResponseEntity<String> patchStudent(PatchStudentRequestDto dto) {
        ...
        // 1. student class로 접근 (StudentRepository 사용)
