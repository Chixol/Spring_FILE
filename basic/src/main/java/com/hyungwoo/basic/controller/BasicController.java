...
import com.hyungwoo.basic.service.BasicService;
import com.hyungwoo.basic.service.implement.BasicServiceImplement;
...
public class BasicController {
    ...
    //@Autowired : 등록된 Spring Bean으로 제어의 역전을 통해서 의존성을 주입하는 방법
    ...
    // - 고수준의 모듈에서 저수준의 모듈을 직접 참조하지 않고 추상화를 통해 간접 참조함으로서 각 모듈간의 결합도를 낮춤 -> 코드의 재사용성 향상, 유지보수성 향상
